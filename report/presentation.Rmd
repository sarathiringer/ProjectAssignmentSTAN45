...
```{r fap-all, echo=FALSE, out.width='100%', fig.height=6, results='hide', message=FALSE, warning=FALSE}
...
```{r cutoff-rf, echo=FALSE, out.width='100%',  results='hide', message=FALSE, message=FALSE, warning=FALSE}
